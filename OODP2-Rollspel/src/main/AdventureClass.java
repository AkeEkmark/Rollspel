...
public class AdventureClass {
	...
	public AdventureClass() {
		...
		Location secondRoom = dlb.buildLocation(
				"You enter a long narrow tunnel that descends towards the light of a room further ahead.",
				new Skeleton("In the distant you hear footsteps echoing and a rattling sound. A skeleton prison guard becomes visible and he has spotted you. He draws his sword and screams in rage as he runs towards you in a furious attack. Prepare to fight!"), null, null);
		...
		Location fourthRoom = dlb.buildLocation("You enter a hallway and a chandelier shines its dim light upon you. There are two doors leading out from where you are, one to the east and another to the west. After a closer examination you find that each of the doors have inscriptions carved on them. The inscription on the east door reads as follows: What begins and has no end? And another inscription is carved on the west door: What is always coming but never arrives? You reckon that theese are riddles of some kind, which door do you choose?", null, null, null);
		...
		Location sixthRoom = dlb.buildLocation("A large oval chamber with an ornamented altar with mystical engravings in its centre. To the north you see a spiral staircase descending.", new DarkDemon("A man dressed in a black robe kneels in front of the altar with his back turned against you. An aura of evil surrounds the man and it grows stronger by the second. When the man becomes aware of your prescence he suddenly and swiftly turns towards you, At first glanze, he appears to be human but it sends a chill down your spine as his face is revealed and you look into his lifeless eyes. Its a dark demon and he spits in rage as he unsheatens a large black broadsword with strangely carved engravings. -filthy human, you will never leave this place alive, he hisses as he attacks you. Prepare to fight the Dark Demon Templar"), null, null);
		dungeonMap.add(sixthRoom);
		
		fourthRoom.setEastExit(fifthRoom);
		fourthRoom.setWestExit(sixthRoom);
		Location seventhRoom = dlb.buildLocation("The staircase descends underground and into a tunnel, you see a distant light far ahead. You run through the narrow passage which eventually leads you out in the open forest. Your heart is pounding and you are all sweaty. You hear a distant gong echoes from the castle in the background and your only hope is that there are no followers and that you will achieve your freedom at last..", null, null, null);
